...
# her hents datasettene fra Chicago Booth. Disse må lastes ned på forhånd. 


count <- read_dta("/Users/johannespedersen/Desktop/Skole/SOK-1005 Datavitenskap/Prosjektoppgave/data/ccount.dta",encoding="latin1")

demo <- read_dta("/Users/johannespedersen/Desktop/Skole/SOK-1005 Datavitenskap/Prosjektoppgave/data/demo.dta", encoding="latin1")

UPC <- read.csv("/Users/johannespedersen/Desktop/Skole/SOK-1005 Datavitenskap/Prosjektoppgave/data/upc.csv")

move <- read.csv("/Users/johannespedersen/Desktop/Skole/SOK-1005 Datavitenskap/Prosjektoppgave/data/movement.csv")
